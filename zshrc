...
alias dstat-full='\dstat -Tclmdrn --bits --nocolor'
alias dstat-mem='\dstat -Tclm --bits --nocolor'
alias dstat-cpu='\dstat -Tclr --bits --nocolor'
alias dstat-net='\dstat -Tclnd --bits --nocolor'
alias dstat-disk='\dstat -Tcldr --bits --nocolor'
